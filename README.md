...
6. **Model Selection**
   ...
   * Random Forest with class weights selected as final model
...
| ------------------- | --------- | -------- | -------- | -------- |
| Logistic Regression | 0.06      | 0.87     | 0.10     | 0.96     |
| Decision Tree       | 0.03      | 0.84     | 0.07     | 0.92     |
| **Random Forest**   | **0.84**  | **0.76** | **0.80** | **0.97** |
